...
$(function() {
    ...
    wind.on("scroll",function () {
        ...
        if(bodyScroll > 1){
            ...
            logo.attr('src', 'http://innovationplans.com/themeforest/sodic/img/logo-dark.png');

        }else{

            navbar.removeClass("nav-scroll");
            logo.attr('src', 'http://innovationplans.com/themeforest/sodic/img/logo-light.png');
        }
    });
...
$(window).on("load",function (){
    ...
    $('#contact-form').on('submit', function (e) {
        if (!e.isDefaultPrevented()) {
            var url = "http://innovationplans.com/themeforest/sodic/contact.php";
